...
def init_db(conn: sqlite3.Connection) -> None:
    ...
    _add_column_if_missing(cur, "applications", "status", "status TEXT NOT NULL DEFAULT 'considering'")
    _add_column_if_missing(cur, "applications", "ai_analysis", "ai_analysis TEXT")
    _add_column_if_missing(cur, "applications", "ai_match_score", "ai_match_score REAL")
